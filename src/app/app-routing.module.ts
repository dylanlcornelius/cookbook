...
const routes: Routes = [
  { path: '', title: 'Home', redirectTo: 'home', pathMatch: 'full' },
  {
    ...
    canActivate: [LoginGuard, UserPendingGuard],
  },
  ...
  { path: 'tutorial', title: 'Tutorial', component: TutorialComponent, canActivate: [LoginGuard] },
  {
    ...
    canActivateChild: [LoginGuard, UserPendingGuard],
  },
  {
    path: 'ingredient',
  ...
  },
  {
    ...
    canActivateChild: [LoginGuard, UserPendingGuard, AdminGuard],
  },
];
...
@NgModule({
  ...
  providers: [{ provide: TitleStrategy, useClass: TitleService }],
})
